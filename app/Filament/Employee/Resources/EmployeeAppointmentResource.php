                ...
                Forms\Components\Section::make('Data Pegawai yang Diangkat')
                    ...
                    ->schema([
                        Forms\Components\Select::make('employee_id')
                            ->label('Pegawai')
                            ->options(function () {
                                return Employee::with('employmentStatus')
                                    ->get()
                                    ->mapWithKeys(fn ($emp) =>
                            ...
                            ->helperText('Pilih pegawai yang statusnya akan berubah'),
                        ...
                        Forms\Components\Placeholder::make('employee_info_placeholder')
                            ...
                            ->content(function (Forms\Get $get) {
                                ...
                                $employee = Employee::with(['employmentStatus', 'department', 'position'])->find($id);
                ...
                Forms\Components\Section::make('Perubahan Status Kepegawaian')
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('new_employment_status_id')
                            ...
                            ->preload()
                            ->required()
                            ->helperText('Pilih status kepegawaian baru yang akan diterapkan'),
                    ])->columns(2),
