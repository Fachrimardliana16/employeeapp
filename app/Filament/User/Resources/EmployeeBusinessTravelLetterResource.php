...
class EmployeeBusinessTravelLetterResource extends Resource
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        $userId = Auth::id();
        $count = Cache::remember('nav_badge_user_travel_' . $userId, now()->addMinutes(5), fn () =>
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('download_pdf')
                        ...
                        ->url(fn(EmployeeBusinessTravelLetter $record) => $record->pdf_file_path ? url('image-view/' . $record->pdf_file_path) : null)
                        ->openUrlInNewTab()
