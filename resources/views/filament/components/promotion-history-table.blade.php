...
@if($promotions->isEmpty())
    <div class="text-sm text-gray-500 py-4 text-center border rounded-xl dark:border-white/10">Belum ada histori kenaikan golongan.</div>
@else
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-white/5 bg-white dark:bg-gray-900">
                    @foreach ($promotions as $promotion)
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition duration-75">
                            ...
                            <td class="px-4 py-4 text-sm align-top whitespace-nowrap text-sm">
