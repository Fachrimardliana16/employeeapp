...
<x-filament::section
    ...
    heading="Histori Kontrak Kerja"
    description="Daftar perjalanan kontrak kerja pegawai"
>
    @if($agreements->isEmpty())
        <div class="text-sm text-gray-500 py-4 text-center">Belum ada histori kontrak kerja.</div>
    @else
