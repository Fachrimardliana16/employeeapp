...
<x-filament::section
    ...
    heading="Data Keluarga"
    description="Informasi anggota keluarga pegawai"
>
    @if($families->isEmpty())
        <div class="text-sm text-gray-500 py-4 text-center">Belum ada data keluarga.</div>
    @else
                ...
                <table class="w-full text-left divide-y table-auto border-collapse divide-gray-200 dark:divide-white/5">
                    <thead class="bg-gray-50 dark:bg-white/5">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap">L/P</th>
