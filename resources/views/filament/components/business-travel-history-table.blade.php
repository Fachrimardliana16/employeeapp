...
<x-filament::section
    ...
    heading="Histori Perjalanan Dinas"
    description="Daftar perjalanan dinas pegawai"
>
    @if($travels->isEmpty())
        <div class="text-sm text-gray-500 py-4 text-center">Belum ada histori perjalanan dinas.</div>
    @else
                        ...
                        @foreach ($travels as $travel)
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition duration-75">
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-400 align-top">
                                    <div class="font-medium text-gray-900 dark:text-gray-100">{{ $travel->destination }}</div>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-900 dark:text-white align-top text-right">
